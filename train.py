...
def map_sentiment(label):
    ...
    negative = {'anger', 'anxiety', 'apprehensive', 'boredom', 'confusion', 'despair', 'disappointment', 'disgust', 'embarrassed', 'fear', 'frustrated', 'grief', 'hate', 'heartache', 'helplessness', 'jealousy', 'loneliness', 'melancholy', 'misery', 'numbness', 'regret', 'resentment', 'sad', 'sadness', 'shame', 'sorrow', 'stress', 'suffering', 'terror', 'worried'}
...
# Remove platform classes with fewer than 2 samples to avoid stratify error
platform_counts = df['Platform'].value_counts()
valid_platforms = platform_counts[platform_counts >= 2].index
